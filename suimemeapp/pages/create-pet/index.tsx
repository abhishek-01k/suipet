      ...
      <div className="w-full max-w-4xl mx-auto py-24 px-4">
        ...
        <div className="flex justify-center mb-12">
          <div className="flex items-center">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 1 ? 'bg-purple-500 text-white' : 'bg-gray-200 text-gray-600'}`}>1</div>
            <div className={`w-16 h-1 ${step >= 2 ? 'bg-purple-500' : 'bg-gray-200'}`}></div>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 2 ? 'bg-purple-500 text-white' : 'bg-gray-200 text-gray-600'}`}>2</div>
            <div className={`w-16 h-1 ${step >= 3 ? 'bg-purple-500' : 'bg-gray-200'}`}></div>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 3 ? 'bg-purple-500 text-white' : 'bg-gray-200 text-gray-600'}`}>3</div>
          </div>
        </div>
        ...
        {!account ? (
          <div className="text-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
            ...
            <ConnectButton className="neo-btn bg-purple-500 text-white px-6 py-3 rounded-md font-bold" />
          </div>
        ) : (
          <>
            {/* Step 1: Select Memecoin */}
            {step === 1 && (
              <div className="bg-white p-8 rounded-lg neo-brutalism-shadow">
